...
public class Script_PNG_2 : MonoBehaviour
{
    ...
    public bool is_click1 = false;
    public bool is_sceau = false;
                ...
                if (is_sceau == true)
                {
                    ...
                    if(is_fight==true)
                    {
                        if (killed_mobs < 3)
                        {
                            ...
                            if (GUI.Button(new Rect(30, 85, 250, 25), "Faire apparaître 3 créatures maléfiques"))
                            {
                        ...
                        if (killed_mobs>=3)
                        {
                            GUI.BeginGroup(new Rect(Screen.width / 2 - 150, Screen.height / 2 + 15, 300, 120));
                            GUI.Box(new Rect(0, 0, 300, 120), "Mage");
                            GUI.Label(new Rect(20, 30, 250, 110), "Tu n'es plus un novice à present ! Tu peux à présent arpenter notre monde et parler avec les différents personnages!");
                        }
