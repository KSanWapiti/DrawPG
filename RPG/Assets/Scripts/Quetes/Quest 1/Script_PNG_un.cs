...
public class Script_PNG_un : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (showGUI)
        {
            ...
            {
                LabelWrite("Messager du roi", "Ta détermination semble être au rendez-vous ! Retrouve moi à l'extérieur pour débuter ton apprentissage",false);
                if (GUI.Button(new Rect(85, 87, 130, 20), "Le retrouver dehors"))
                {
